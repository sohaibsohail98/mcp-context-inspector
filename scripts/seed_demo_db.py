...
def build_sessions():
    ...
    prompts = [
        ...
        ("did the last checkout-api deploy cause the regression?", SONNET, _trace(("get_recent_deployments", "ok"), ("get_service_metrics", "ok"), ("search_logs", "error")), [1900, 2000, 1700, 1200], "Timing lines up with the 14:02 deploy, but search_logs couldn't confirm via logs — treat this as likely, not certain."),
